...
<a href="view-dues"><img src="image/turn-back.png" alt="Edit" class="w-5 h-5 inline-block mr-2 ml-20 mt-5"></a>
    ...
    <h2 class="ml-10 font-semibold text-xl leading-7 text-gray-900 mt-5">CREATE HEAMS HOTEL ADMIN</h2>
        ...
        <div class="mt-2">
        <h1 for="name" class="text-sm font-medium  text-gray-900 font-bold ">ADMIN INFORMATION</h1>
        </div>
        <div class="grid grid-cols-3 gap-x-6 gap-y-3 sm:grid-cols-3 mt-3">
            ...
            <div class="grid grid-cols-3 gap-x-6 gap-y-3 sm:grid-cols-3 mt-3">
                ...
                <div>
                    ...
                    <input wire:model='confirmPass' type="password" id="" name="confirmPass" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 pl-5 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 mt-1" placeholder="Enter Role">
                    @error('confirmPass')
                        <span class="text-red-500 text-xs mt-2 block">{{ $message }}</span>
                    @enderror
                </div>
